...
function calculateDescriptors_CT(sample_name,run_num,varargin)
...
if run_num==2
    filename=fullfile('E:\pape_code\prepocessing\Data',[sample_name,'volmov.tif']);
else
    filename=fullfile('E:\pape_code\prepocessing\Data',[sample_name,'volfix.tif']);
end
