...
function registerWithDescriptors_correct(moving_run,sample_name)

    loadExperimentParams_xp;
...
%                         params.SAMPLE_NAME,params.FIXED_RUN,params.DATACHANNEL));
    filename=fullfile('C:\Users\xp\Documents\GitHub\MCMCregistration\preprocessing\Data\',[sample_name,'volfix.tif']);

    imgFixed_total = load3DTif(filename);
    
    filename=fullfile('C:\Users\xp\Documents\GitHub\MCMCregistration\preprocessing\Data\',[sample_name,'volmov.tif']);
...
%         filename=fullfile('..\Data\input\volmov.tif');
...
%        [in1D_total,out1D_total] = TPS3DWarpWhole(keyM_total,keyF_total, ...
        ...
        [in1D_total,out1D_total] = TPS3DWarpWholeInParallel_correct(keyM_total,keyF_total, ...
