...
in_to_ex_path = 'H:/CTVI/Results/Continuous_figure/SD01/';
...
if strcmp(RefVI_type,'Galligas')
    ...
    CTVI_path = 'H:/CTVI/Results/CTVI_results/Continuous_figure/SD01/';
    subject_num = 25;
    num_phase = 5;
else
...
%                 % show supervoxel_seg
%                 %             show_supervoxel_seg(vol_ex_sup_cur,SLIC_Labels_3D)
%                 
...
%                     V_after, C_p_in,labels_index,Tptv,spc);
%                 show_supervoxel_ventilation(vol_ex_nonor,vent_img_cur);
...
%     figure
    show_overlay_sagittal_CTVI_continuous(avg_img_orig, vent_img_avg_filter_all, info_GT, GT_mask, index_slice,'hot',num_phase-1)
