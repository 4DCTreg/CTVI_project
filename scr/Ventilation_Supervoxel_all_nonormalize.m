function [vent_img, vent_img_sup] = Ventilation_Supervoxel_all_nonormalize(vol_ex,vol_in,vent_jac_interp,SLIC_Labels_3D,V_after,...
...
%                 sup_jac_coef = ones(size(sup_jac_coef,1),1);
        ...
        vent_img_sup(vol_sup_ex_index) = sup_vent;
    end
end
