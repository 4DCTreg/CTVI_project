function vent_img = Ventilation_Supervoxel_SD_03_nonormalize(vol_ex,vol_in,SLIC_Labels_3D,vent_HU,V_after,...
...
%         sup_vent = ((volin_air_sum - volex_air_sum)/volex_air_sum)*(m_ex+1024)/774;
...
%         end
        ...
        sup_vent_HU = vent_HU(vol_sup_ex_index);
