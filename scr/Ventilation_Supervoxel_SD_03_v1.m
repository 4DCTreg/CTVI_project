function vent_img = Ventilation_Supervoxel_SD_03_v1(vol_ex,vol_in,SLIC_Labels_3D,vent_HU,...
...
for id = 1:Numlabels
    ...
    sup_vent_HU = vent_HU(vol_ex_index);
    sup_vent_HU = mean(sup_vent_HU);
    vent_img(vol_ex_index) = sup_vent_HU;
...
% %         options.Damped = 0;
% %         options.LS_type = 0; options.LS_init = 4; %
...
vent_img = img_thr(vent_img_mask, min_p_value, max_p_value, 15000);
