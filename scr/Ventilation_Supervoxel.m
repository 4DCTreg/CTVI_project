function vent_img = Ventilation_Supervoxel(vol_ex,vol_in,vent_jac_interp,SLIC_Labels_3D,V_before,V_after,...
    C_p_in,C_p_ex,supvoxel_sz_ex,labels_index,Tptv,spc)
