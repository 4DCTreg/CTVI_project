function vent_img = Ventilation_Supervoxel_SD02(vol_ex,vol_in,vol_ex_mask_crop,vent_jac_interp,SLIC_Labels_3D,V_after,...
...
min_value = min(vent_img(:));
vent_img = vent_img-min_value;
vent_img_mask = vent_img.*vol_ex_mask_crop;
