function [vent_img_mask] = Ventilation_HU(vol_ex, vol_in, T_rsz, spc)
...
% min_p_value = vent_index_sort(round(0.05*vol_size(1)*vol_size(2)*vol_size(3)));
% max_p_value = vent_index_sort(round(0.95*vol_size(1)*vol_size(2)*vol_size(3)));
