function vent_img = Ventilation_Supervoxel_HU(vol_ex,vol_in,SLIC_Labels_3D,...
    labels_index,Tptv_rsz,spc)
% this version use classic HU method, multi vol_in to single vol_ex;
...
max_p_value = vent_index_sort(round(0.99*im_sz(1)*im_sz(2)*im_sz(3)));
