...
for num = 1 :subject_num
    ...
    d = [10, 10, 5];
    crop_v = crop_mask(avg_mask,info_mask.Dimensions,d);
    crop_v_GT = crop_mask(GT_mask,info_mask_GT.Dimensions,d);
...
save results_iso_dir_jac_111.mat TREs_or TREs SpR
