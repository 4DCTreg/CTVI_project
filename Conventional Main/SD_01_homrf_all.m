...
in_to_ex_path = 'H:/CTVI/Results/SD_01_in_to_ex_homrf_multi_sup/';
...
for num = 21 :subject_num
    ...
    if strcmp(VI_metric,'Supervoxel')
        %         in_to_ex_iso = 'H:/CTVI/Results/SD_01_in_to_ex_iso_multi_sup/subject_16.mat';
        %         load(in_to_ex_iso);
        [vent_jac_interp] = Ventilation_Jac_coef(vol_ex_ROI, Tptv, spc);
        %         [vent_HU] = Ventilation_HU(vol_ex_ROI,vol_in_ROI, Tptv, spc);
