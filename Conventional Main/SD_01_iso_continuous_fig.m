...
if strcmp(RefVI_type,'Galligas')
    ...
    CTVI_path = 'H:/CTVI/Results/Continuous_figure/SD01/';
    subject_num = 25;
    num_phase = 5;
else
...
for num = 22 :subject_num
    ...
    figure
    show_overlay_sagittal_CTVI_continuous(avg_img_orig, vent_img_avg_filter_all, info_GT, GT_mask, index_slice,'hot')
