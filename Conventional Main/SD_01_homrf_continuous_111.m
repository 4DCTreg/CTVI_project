...
in_to_ex_path_homrf = 'H:/CTVI/Results/SD_01_in_to_ex_homrf_multi_sup/';
...
%     [~, Knots_n_rsz] = uncrop_data(voldef, Tptv_rsz, crop_v, init_size);
    ...
    if strcmp(VI_metric,'DIR_Jac')
        [vent_img] = Ventilation_Jac_iso(vol_ex, Knots_n_tot, spc_orig);
    else
...
save SD_01_homrf_jac.mat TREs_or TREs SpR R_tre_sp