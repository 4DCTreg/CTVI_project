...
save_path = 'H:/CTVI/Results/SD_03_ex_to_avg_sup_multi/';
for num = 9:subject_num
    ...
    avg_img = crop_data(avg_img, crop_v);
    n_seeds = 2000;
    ...
    [voldef, Tptv_co, Kptv] = ptv_register(vol_ex, avg_img, opts);
    T_pix_ex_to_avg = conv_3d_T_from_phys_to_pix(Tptv_co, spc_orig);
    
    savename = [save_path,'subject_',num2str(num),'.mat'];
    save(savename,'T_pix_ex_to_avg');
