...
for num = 20:subject_num
    ...
    vol_ex_orig = vol_ct(:,:,:,6);
    
    d = [10, 10, 5];
    crop_v = crop_mask(avg_mask_orig,info_mask.Dimensions,d);
    ...
    [pts_in,pts_ex] = SIFT_extract_landmarks(vol_in, vol_ex, units, crop_v, avg_mask_orig);
...
save landmarks_03.mat landmarks_SIFT
