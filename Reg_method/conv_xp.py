...
def conv3D_accelerate(img_1, filter_1, groups,channel,Nc, Nr,Ns, Nfc, Nfr, Nfs):
    ...
    tar_filter = np.full((groups, 1, Nfr, Nfc, Nfs), 1, dtype='float32')


    m_filter_tensor = torch.from_numpy(tar_filter).view(groups, 1, Nfr, Nfc, Nfs).cuda()
    ...
    #output3d_1 = array.array('d', output3d_1.cpu().numpy())
    m_output3d_1 = F.conv3d(target_tensor_1 ** 2, m_filter_tensor, groups=groups)
    #m_output3d_1 = array.array('d', m_output3d_1.cpu().numpy())
    ...
    #output3d_2 = array.array('d', output3d_2.cpu().np())
    m_output3d_2 = F.conv3d(target_tensor_2 ** 2, m_filter_tensor, groups=groups)
    #m_output3d_2 = array.array('d', m_output3d_2.cpu().numpy())
    ...
    #output3d_3 = array.array('d', output3d_3.cpu().numpy())
    m_output3d_3 = F.conv3d(target_tensor_3 ** 2, m_filter_tensor, groups=groups)
    #m_output3d_3 = array.array('d', m_output3d_3.cpu().numpy())
    ...
    #output3d_4 = array.array('d', output3d_4.cpu().numpy())
    m_output3d_4 = F.conv3d(target_tensor_4 ** 2, m_filter_tensor, groups=groups)
    #m_output3d_4 = array.array('d', m_output3d_4.cpu().numpy())
    ...
    #output3d_5 = array.array('d', output3d_5.cpu().numpy())
    m_output3d_5 = F.conv3d(target_tensor_5 ** 2, m_filter_tensor, groups=groups)
    #m_output3d_5 = array.array('d', m_output3d_5.cpu().numpy())
    ...
    #output3d_6 = array.array('d', output3d_6.cpu().numpy())
    m_output3d_6 = F.conv3d(target_tensor_6 ** 2, m_filter_tensor, groups=groups)
    #m_output3d_6 = array.array('d', m_output3d_6.cpu().numpy())
    output3d_1 = output3d_1.cpu().numpy()
    output3d_2 = output3d_2.cpu().numpy()
    output3d_3 = output3d_3.cpu().numpy()
    output3d_4 = output3d_4.cpu().numpy()
    output3d_5 = output3d_5.cpu().numpy()
    output3d_6 = output3d_6.cpu().numpy()

    m_output3d_1 = m_output3d_1.cpu().numpy()
    m_output3d_2 = m_output3d_2.cpu().numpy()
    m_output3d_3 = m_output3d_3.cpu().numpy()
    m_output3d_4 = m_output3d_4.cpu().numpy()
    m_output3d_5 = m_output3d_5.cpu().numpy()
    m_output3d_6 = m_output3d_6.cpu().numpy()
