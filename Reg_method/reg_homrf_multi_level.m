function [Knots_n_tot,Knots_n]=reg_homrf_multi_level(parameter,...
    volmov,volfix,init_size,pts_fix_or,pts_mov_or,bszv,crop_v)

[nlevel,k_down,x_tot, y_tot, z_tot, useTop, grid_space, metric, labels_search,...
    presmooth, quant, smooth_co_pre, endl, Tcoe_n, top_co, spc, resize, dist_co] = homrf_process_parameters(parameter);
