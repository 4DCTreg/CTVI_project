...
%     unary_tot=Get_Data_Term_3D_MIND_mask(mind_volmov,mind_volfix,mov_mask,fix_mask,griddim,O_trans_X,O_trans_Y,...
%         O_trans_Z,labels,level,previous,quant);
%     unary_tot=Get_Data_Term_3D_MIND(mind_volmov,mind_volfix,griddim,O_trans_X,O_trans_Y,...
%         O_trans_Z,labels,level,previous,quant);

    unary_tot = Get_Data_Term_3D_MIND_GPU(mind_volmov,mind_volfix,griddim,O_trans_X,O_trans_Y,...
