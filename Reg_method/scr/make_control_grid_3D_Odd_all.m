...
function O_trans_all=make_control_grid_3D_Odd_all(grid_space,sizeI,nlevel)

 O_trans_all=cell(nlevel);
if(length(sizeG)==2)
    ...
    O_trans_Z(:,:,:,1)=Z_1;
    O_trans_Z(:,:,:,2)=Z_2;
    O_trans=cat(5,O_trans_X,O_trans_Y,O_trans_Z);
    
    O_trans_all{i}=O_trans;
    end
end
end