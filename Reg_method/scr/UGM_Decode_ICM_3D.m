function  [Ln,labelstot] = UGM_Decode_ICM_3D(labels,dist,dist_co,...
    neighbor,griddim,nodePot,level,k_down,useTop,previous,x_tot,y_tot,z_tot...
    ,labelstot,grid_space,spc,quant,smooth_co_tot,Tcoe_n_tot,top_co_tot)
num_neighbor=18;
