function [nlevel,k_down,x_tot, y_tot, z_tot, useTop, grid_space, metric, labels_search,...
    presmooth, quant, smooth_co_pre, endl, Tcoe_n, top_co, spc, resize, dist_co] = homrf_process_parameters_continuous_SD_02(parameters)
...
grid_space= getoptions(parameters, 'grid_space',[ 9 9 9;]);
metric= getoptions(parameters, 'metric','MIND');
labels_search= getoptions(parameters, 'labels',[ 9 9 9;]);
presmooth= getoptions(parameters, 'presmooth', []);
quant= getoptions(parameters, 'quant',[ 1 1 1;]);
